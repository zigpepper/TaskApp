...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategoryEdit = (EditText) findViewById(R.id.category_edit_text); //追加部分
        ...
        if (mTask == null) {
            ...
            mCategoryEdit.setText(mTask.getCategory()); //追加部分
    ...
    private void addTask() {
        ...
        String category = mCategoryEdit.getText().toString(); //追加部分

        mTask.setTitle(title);
        mTask.setContents(content);
        mTask.setCategory(category); //追加部分
